...
<div class="card"><h3>Bab Skripsi</h3><?php if(!$bab): ?><p>Belum ada bab yang diunggah.</p><?php else: ?><table><tr><th>Bab</th><th>Versi</th><th>Status</th><th>Revisi</th><th>File</th></tr><?php foreach($bab as $row): ?><tr><td><?=e($row['nama_bab'])?></td><td><?=e($row['versi'])?></td><td><?=e(ucfirst(str_replace('_',' ',$row['status'])))?></td><td><?=e($row['total_revisi'])?></td><td><a class="btn btn-primary" target="_blank" rel="noopener" href="download.php?id=<?=$row['id']?>">Buka</a></td></tr><?php endforeach; ?></table><?php endif; ?></div>
