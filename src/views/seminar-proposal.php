<?php
// Tandai seminar proposal selesai: hanya Pembimbing 1 (bukan admin), setelah proposal penelitian disetujui.
// Pembimbing 1 juga dapat membatalkan tanda seminar selama Bab 4 belum diunggah. Membutuhkan $item dan $role.
if (!proposal_ready($conn) || $role !== 'dosen') return;
...
<?php elseif ($seminarStage['tahap'] === 'selesai' && !p2_latest_documents($conn, (int)$item['id'])['bab'][4]): ?>
